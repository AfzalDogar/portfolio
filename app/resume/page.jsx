    ...
    skillList: [
      {
        icon: <FaHtml5 />,
        name: "HTML 5",
        color: "text-orange-500", // Unique color for HTML
      },
      {
        icon: <FaCss3 />,
        name: "CSS 3",
        color: "text-blue-500", // Unique color for CSS
      },
      {
        icon: <FaJs />,
        name: "JavaScript",
        color: "text-yellow-500", // Unique color for JavaScript
      },
      {
        icon: <FaReact />,
        name: "React",
        color: "text-cyan-400", // Unique color for React
      },
      {
        icon: <FaBootstrap />,
        name: "Bootstrap",
        color: "text-purple-600", // Unique color for Bootstrap
      },
      {
        icon: <SiTailwindcss />,
        name: "Tailwind",
        color: "text-teal-400", // Unique color for Tailwind
      },
      {
        icon: <FaFigma />,
        name: "Figma",
        color: "text-pink-500", // Unique color for Figma
      },
      {
        icon: <TbBrandNextjs />,
        name: "Next.js",
